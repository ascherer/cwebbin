...
"wmerge.cxx" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	tie -c wmerg-p19.ch examples/wmerge.w wmerg-patch.ch wmerg-ansi.ch wmerg-extensions.ch wmerg-memory.ch wmerg-output.ch 
	ctangle examples/wmerge.w wmerg-p19.ch wmerge.cxx 
