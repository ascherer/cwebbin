...
#line 133 "ctang-foo.ch"
void
init_node(
name_pointer node)
#line 202 "ctangle.w"
{
#line 141 "ctang-foo.ch"
node->equiv= (void*)text_info;
#line 204 "ctangle.w"
}
#line 148 "ctang-foo.ch"
void
...
#line 157 "ctang-foo.ch"
static void
store_two_bytes(
sixteen_bits x)
#line 264 "ctangle.w"
{
#line 165 "ctang-foo.ch"
...
/*:104*/
#line 755 "ctang-foo.ch"

}else
rename(check_file_name,output_file_name);

/*:103*/
#line 307 "ctang-foo.ch"
...
#line 468 "ctang-foo.ch"
err_print(_("! Section name didn't end"));break;
#line 1150 "ctangle.w"

}
if(ccode[(eight_bits)c]==section_name){
#line 474 "ctang-foo.ch"
...
while((c= skip_ahead())=='@');
if(*(loc-1)!='>')
#line 600 "ctang-foo.ch"
err_print(_("! Double @ should be used in control text"));
#line 1500 "ctangle.w"

break;
}
#line 606 "ctang-foo.ch"
