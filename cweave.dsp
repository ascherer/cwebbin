...
"cweave.cxx" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	tie -c comm-p19.hch common.h comm-ansi.hch comm-extensions.hch comm-memory.hch comm-translation.hch comm-output.hch 
	tie -m comm-p19.h common.h comm-p19.hch 
	tie -c cweav-p19.ch cweave.w cweav-patch.ch cweav-ansi.ch cweav-extensions.ch cweav-memory.ch cweav-translation.ch cweav-output.ch 
	ctangle cweave.w cweav-p19.ch cweave.cxx 
