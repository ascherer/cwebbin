...
#define MSG_FATAL_CO75_1_STR "! Usage: ctangle [options] webfile[.w] " \
...
#define MSG_FATAL_CO75_2_STR "! Usage: ctangle [options] webfile[.w] " \
	"[{changefile[.ch]|-} [outfile[.c]]]\n" \
	"Options are (+ turns on, - turns off, default in brackets):\n" \
	"b [+] print banner line\n" \
	"h [+] print happy message\n" \
...
#define MSG_FATAL_CO75_3_STR "! Usage: cweave [options] webfile[.w] " \
	"[{changefile[.ch]|-} [outfile[.tex]]]\n" \
	"Options are (+ turns on, - turns off, default in brackets):\n" \
	"b [+] print banner line\n" \
	"e [-] enclose C material in \\PB brackets\n" \
	"f [+] force line breaks\n" \
	"h [+] print happy message\n" \
...
#define MSG_FATAL_CO75_4_STR "! Usage: cweave [options] webfile[.w] " \
	"[{changefile[.ch]|-} [outfile[.tex]]]\n" \
	"Options are (+ turns on, - turns off, default in brackets):\n" \
	"b [+] print banner line\n" \
	"e [-] enclose C material in \\PB brackets\n" \
...
#define MSG_BANNER_CT1_STR "This is CTANGLE (Version 3.64 [CWEBbin 2018])"
...
#define MSG_PROGRESS_CT42_3_STR "Done."
...
#define MSG_BANNER_CW1_STR "This is CWEAVE (Version 3.64 [CWEBbin 2018])"
