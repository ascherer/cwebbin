...
#line 714 "comm-foo.ch"
/*:60*//*63:*/
#line 1173 "common.w"

#line 777 "comm-foo.ch"
...
*limit= ' ';
if(buffer[0]=='@'){
#line 342 "comm-foo.ch"
if(xisupper(buffer[1]))buffer[1]= tolower((eight_bits)buffer[1]);
#line 554 "common.w"
if(buffer[1]=='x'||buffer[1]=='y'){
loc= buffer+2;
#line 348 "comm-foo.ch"
...
char*s;
name_pointer q= p+1;
#line 562 "comm-foo.ch"
int name_len= (int)(last-first)+ispref;
#line 568 "comm-foo.ch"
if(name_ptr>=name_dir_end)overflow(_("name"));
#line 896 "common.w"
...
if(show_stats)
print_stats();
#line 740 "comm-foo.ch"
/*62:*/
#line 1160 "common.w"

switch(history){
#line 764 "comm-foo.ch"
case spotless:
...
/*:61*//*64:*/
#line 786 "comm-foo.ch"
void
fatal(
const char*s,const char*t)
#line 1182 "common.w"
{
#line 794 "comm-foo.ch"
if(*s)fputs(s,stdout);
#line 1184 "common.w"
err_print(t);
