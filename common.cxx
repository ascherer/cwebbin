...
/*:22*//*81:*/
#line 969 "comm-foo.ch"

#include <string.h> 

/*:81*//*87:*/
#line 1062 "comm-foo.ch"
...
FILE*tex_file;
FILE*idx_file;
#line 909 "comm-foo.ch"
FILE*scn_file;
FILE*check_file;
#line 1375 "common.w"
FILE*active_file;

#line 926 "comm-foo.ch"
/*:77*/
#line 61 "common.w"
...
#line 814 "comm-foo.ch"
static void scan_args(void);
#line 1253 "common.w"

/*:69*//*82:*/
#line 976 "comm-foo.ch"
...
char*s;
name_pointer q= p+1;
#line 501 "comm-foo.ch"
int name_len= (int)(last-first)+ispref;
#line 507 "comm-foo.ch"
if(name_ptr>=name_dir_end)overflow(get_string(MSG_OVERFLOW_CO39_2));
#line 896 "common.w"
...
if(show_stats)
print_stats();
#line 677 "comm-foo.ch"
/*62:*/
#line 1160 "common.w"

switch(history){
#line 704 "comm-foo.ch"
case spotless:
