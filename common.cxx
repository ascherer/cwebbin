...
/*:22*//*81:*/
#line 980 "comm-foo.ch"

#include <string.h> 

/*:81*//*85:*/
#line 1022 "comm-foo.ch"
...
#line 657 "comm-foo.ch"
extern int wrap_up(void);
extern void print_stats(void);
#line 1143 "common.w"

#line 668 "comm-foo.ch"
/*:60*//*63:*/
#line 1173 "common.w"

#line 725 "comm-foo.ch"
...
*limit= ' ';
if(buffer[0]=='@'){
#line 302 "comm-foo.ch"
if(xisupper(buffer[1]))buffer[1]= tolower((unsigned char)buffer[1]);
#line 554 "common.w"
if(buffer[1]=='x'||buffer[1]=='y'){
loc= buffer+2;
#line 308 "comm-foo.ch"
...
#line 219 "comm-foo.ch"
/*:21*//*26:*/
#line 569 "common.w"

#line 318 "comm-foo.ch"
void
check_complete(void){
...
if(r!=NULL){
#line 552 "comm-foo.ch"
fputs(_("\n! Ambiguous prefix: matches <"),stdout);
#line 946 "common.w"

print_prefix_name(p);
#line 558 "comm-foo.ch"
fputs(_(">\n and <"),stdout);
#line 949 "common.w"
print_prefix_name(r);
err_print(">");
...
/*:61*//*64:*/
#line 734 "comm-foo.ch"
void
fatal(
const char*s,const char*t)
#line 1182 "common.w"
{
#line 742 "comm-foo.ch"
if(*s)fputs(s,stdout);
#line 1184 "common.w"
err_print(t);
...
/*:64*//*65:*/
#line 750 "comm-foo.ch"
void
overflow(
const char*t)
#line 1193 "common.w"
{
#line 758 "comm-foo.ch"
