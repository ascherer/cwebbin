...
COMM-OUTPUT.CH, COMM-MEMORY.CH, COMM-TRANSLATION.CH to be applied as well.
...
@x l.1116+ and l.198 of COMM-TRANSLATION.CH
...
@x l.1354+ and l.252 of COMM-TRANSLATION.CH
if (program==ctangle) fatal(get_string(MSG_FATAL_CO75_2),"");
else fatal(get_string(MSG_FATAL_CO75_4),"");
@y
#ifdef __SASC
if (program==ctangle) fatal(get_string(MSG_FATAL_CO75_1),"");
